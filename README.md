...
| `enable_maven_repo_mirror` | When enabled and the build runs on Bitrise with the MavenCentral mirror available, Gradle will be configured to download dependencies from the mirror. |  | `true` |
</details>
